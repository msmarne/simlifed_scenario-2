    ...
    def on_snapshot(doc_snapshot, changes ,  read_time):
            ...
            for doc in doc_snapshot:
                ...
                if boolValue == True:
                    ...
                    sleep(2) 
                    GPIO.output(26, True)
                    GPIO.add_event_detect(RELAY_PIN_rawMaterialA, GPIO.FALLING,
                          callback= cb.button_callback_rawMaterialA,bouncetime=50 ) 
                    GPIO.add_event_detect(RELAY_PIN_rawMaterialB, GPIO.FALLING,
                          callback= cb.button_callback_rawMaterialB,bouncetime=50 )
            callback_done.set()
